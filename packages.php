<section class="page-section bg-dark" id="home">
	<div class="container">
		<h2 class="text-left text-dark">Tourist Destination</h2>
	<br>
	<div class="w-100">
        <?php
		$packages = $conn->query("SELECT * FROM `destinations` order by rand() ");
        ...
        ?>
			<div class="card d-flex w-100 rounded-0 mb-3 package-item">
				...
				<div class=" w-100 d-flex justify-content-between">
					 <span class="rounded-0 btn-flat text-sm text-white bg-warning p-1"><?php echo "Entrance Fee &nbsp₱&nbsp".$row['cost'] ?></span>
					<a href="./?page=view_package&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat rounded btn-success">&nbsp;&nbsp;View Details &nbsp<i class="fa fa-arrow-right"></i></a>
				</div>
				</div>
			</div>
		<?php endwhile; ?>
