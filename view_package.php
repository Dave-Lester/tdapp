<?php
if(isset($_GET['id'])){
    $packages = $conn->query("SELECT * FROM `destinations` where md5(id) = '{$_GET['id']}'");
            ...
            <div class="col-md-5">
                ...
                <div class="w-100">
                    ...
                    <div class="w-100 d-flex justify-content-between">
                        <span class="rounded-0 btn-flat text-sm text-white bg-warning p-1 d-flex align-items-center  justify-content-between"><i class="fa fa-tag"></i> <span class="ml-1"><?php echo number_format($cost) ?></span></span>
